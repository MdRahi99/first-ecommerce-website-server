  ...
  try {
    ...
    app.post('/payment-info', verifyJWT, async (req, res) => {
      ...
      const data = {
        ...
        success_url: `${process.env.CLIENT_URL}/payment/success?transactionId=${transactionId}`,
        fail_url: `${process.env.CLIENT_URL}/payment/fail?transactionId=${transactionId}`,
        cancel_url: `${process.env.CLIENT_URL}/payment/cancel?transactionId=${transactionId}`,
